...
IN FUTURE, THE WAY TO TEST THE CURRENT PROGRAM AGAINST A CORRECTLY WORKING VERSION IS:
  ...
  -- SET is_test TO False, PASTE THE ALGS FROM THE FILE "testing/TEST_SUITE_17__INPUT_Wed.txt" INTO THE FILE "alg_list_input.txt", RUN PROGRAM, COMPARE OUTPUT FILE TO THE FILE "testing/TEST_SUITE_17__OUTPUT_Wed__bare.txt" USING DIFFCHECKER ONLINE
