...
def TESTING_3(one_ripple_round_of__final_algs, indx, YorZ_added__shifting_turns):
    one_ripple_round_of__final_algs = ["\n\nadd_YorZ__shifting_listTypeAlg  is now:  " + " ".join(YorZ_added__shifting_turns) + "\nThe indexes are going in reverse order; here are the algs for the current index, which is:  " + str(indx) + "\nIF the alg's X-component is X0, the ripple round's base alg is added to the list.\nIt has no wide comps and isn't generated by CompXpansion.\nIt will appear below, standing alone or with its merge_YU partner.\n"] + one_ripple_round_of__final_algs
