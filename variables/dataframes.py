...
df_rotation_codes = pd.read_csv('/Users/justindudley/dev/cube/Alg_Slice_And_Widen_daddy/alg-slice-and-widen/tables/rotation_codes.csv', index_col="X") 
